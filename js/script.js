...
// SET ALL PARALLAX EFFECTS
    ...
    function responsiveEffect(wScroll) {
      ...
      if (window.matchMedia("(max-width: 375px) and (max-height: 667px)").matches) {
        ...
        // Section 1
        $('.wanita-swipe').css({
          'transform' : 'translate('+ (-75) + '%, '+ (240+limQuarter*150) +'%) scale('+ (180) +'%)',
          'opacity': (scrollPercent >= 3.7 ? 0 : 1)
        });
        $('.pria-swipe').css({
          'transform' : 'translate('+ (-145) + '%, '+ (240+limQuarter*150) +'%) scale('+ (180) +'%)',
          'opacity': (scrollPercent >= 3.7 ? 0 : 1)
        });
        $('.quarter').css({
          'position' : 'fixed',
          'transform' : 'translate('+ (19) + '%, '+ (-870-limQuarter*500) +'%) scale('+ (170) +'%)',
          'opacity': (scrollPercent >= 0.8 ? 0 : 1)
        }); 
        $('.quarter2').css({
          'position' : 'fixed',
          'transform' : 'translate('+ (27) + '%, '+ (-300-limQuarter*170) +'%) scale('+ (170) +'%)',
          'opacity': (scrollPercent >= 0.8 ? 0 : 1)
        }); 
        $('.pohon').css({
          'transform' : 'translate('+ (29-limpohon*0.5) + '%, '+ (230+limpohon*0.6) +'%) scale('+ (248 + (limpohon*0.5)) +'%)',
          'opacity': (scrollPercent >= 6.1 ? 0.15 : 1)
        }); 
        $('.pohon-flip').css({
          'transform' : 'translate('+ (-1+limpohon*0.5) + '%, '+ (215-limpohon*0.6) +'%) scaleX(-1) scale('+ (155 + (limpohon*0.5)) +'%)',
          'opacity': (scrollPercent >= 6.1 ? 0.15 : 1)
        }); 
        $('.pohonpohon').css({
          'transform' : 'translate(0, '+ (240-limpohon*0) +'%) scale('+ (300 + (limdaun * 2.7)) +'%)',
          'opacity': (scrollPercent >= 6.1 ? 0.15 : 1)
        }); 
        $('.daun').css({
          'transform' : 'translate(0, '+ (-280-limdaun*0.5) +'%) scale('+ (200 + (limdaun * 2.7)) +'%)',
          'opacity': (scrollPercent >= 6.1 ? 0.15 : 1)
        });
        ...
        $('.fsk').css({
          'transform' : 'translate(0, '+ (-220+wScroll*0.65) +'%) scale('+ (58 + (wScroll * 0.15)) +'%)', 'text-shadow': ('1px 1px 1px rgb(0, 0, 0.1)') ,
          'opacity': (scrollPercent >= 0.8 ? 1 : 0)
        });
        $('.img-sec2 .position-start').css({
          'transform' : 'scale('+ (57 + (wScroll * 0.1)) +'%) translate('+ (149-wScroll*0.25) + '%, '+ (-37+wScroll*0.05) +'%)'
        ...
        // Section 1
        $('.wanita-swipe').css({
          'transform' : 'translate('+ (-75) + '%, '+ (300+limQuarter*150) +'%) scale('+ (180) +'%)',
          'opacity': (scrollPercent >= 3.7 ? 0 : 1)
        });
        $('.pria-swipe').css({
          'transform' : 'translate('+ (-145) + '%, '+ (300+limQuarter*150) +'%) scale('+ (180) +'%)',
          'opacity': (scrollPercent >= 3.7 ? 0 : 1)
        });
        $('.quarter').css({
          'position' : 'fixed',
          'transform' : 'translate('+ (19) + '%, '+ (-1350-limQuarter*500) +'%) scale('+ (170) +'%)',
          'opacity': (scrollPercent >= 0.8 ? 0 : 1)
        }); 
        $('.quarter2').css({
          'position' : 'fixed',
          'transform' : 'translate('+ (27) + '%, '+ (-500-limQuarter*170) +'%) scale('+ (170) +'%)',
          'opacity': (scrollPercent >= 0.8 ? 0 : 1)
        }); 
        $('.pohon').css({
          'transform' : 'translate('+ (29-limpohon*0.5) + '%, '+ (285+limpohon*0.6) +'%) scale('+ (248 + (limpohon*0.5)) +'%)',
          'opacity': (scrollPercent >= 6.1 ? 0.15 : 1)
        }); 
        $('.pohon-flip').css({
          'transform' : 'translate('+ (-1+limpohon*0.5) + '%, '+ (247-limpohon*0.6) +'%) scaleX(-1) scale('+ (155 + (limpohon*0.5)) +'%)',
          'opacity': (scrollPercent >= 6.1 ? 0.15 : 1)
        }); 
        $('.pohonpohon').css({
          'transform' : 'translate(0, '+ (290-limpohon*0) +'%) scale('+ (300 + (limdaun * 2.7)) +'%)',
          'opacity': (scrollPercent >= 6.1 ? 0.15 : 1)
        }); 
        $('.daun').css({
          'transform' : 'translate(0, '+ (-320-limdaun*0.5) +'%) scale('+ (200 + (limdaun * 2.7)) +'%)',
          'opacity': (scrollPercent >= 6.1 ? 0.15 : 1)
        });
        ...
        $('.fsk').css({
          'transform' : 'translate(0, '+ (-220+wScroll*0.65) +'%) scale('+ (70 + (wScroll * 0.15)) +'%)', 'text-shadow': ('1px 1px 1px rgb(0, 0, 0.1)') ,
          'opacity': (scrollPercent >= 0.8 ? 1 : 0)
        });
        $('.img-sec2 .position-start').css({
          'transform' : 'scale('+ (57 + (wScroll * 0.1)) +'%) translate('+ (149-wScroll*0.25) + '%, '+ (-37+wScroll*0.05) +'%)'
        ...
        // Section 1
        $('.wanita-swipe').css({
          'transform' : 'translate('+ (-75) + '%, '+ (365+limQuarter*150) +'%) scale('+ (180) +'%)',
          'opacity': (scrollPercent >= 3.7 ? 0 : 1)
        });
        $('.pria-swipe').css({
          'transform' : 'translate('+ (-145) + '%, '+ (365+limQuarter*150) +'%) scale('+ (180) +'%)',
          'opacity': (scrollPercent >= 3.7 ? 0 : 1)
        });
        $('.quarter').css({
          'position' : 'fixed',
          'transform' : 'translate('+ (19) + '%, '+ (-1350-limQuarter*900) +'%) scale('+ (170) +'%)',
          'opacity': (scrollPercent >= 0.8 ? 0 : 1)
        }); 
        $('.quarter2').css({
          'position' : 'fixed',
          'transform' : 'translate('+ (27) + '%, '+ (-500-limQuarter*330) +'%) scale('+ (170) +'%)',
          'opacity': (scrollPercent >= 0.8 ? 0 : 1)
        }); 
        $('.pohon').css({
          'transform' : 'translate('+ (29-limpohon*0.5) + '%, '+ (320+limpohon*0.6) +'%) scale('+ (248 + (limpohon*0.5)) +'%)',
          'opacity': (scrollPercent >= 6.1 ? 0.15 : 1)
        }); 
        $('.pohon-flip').css({
          'transform' : 'translate('+ (-1+limpohon*0.5) + '%, '+ (285-limpohon*0.6) +'%) scaleX(-1) scale('+ (155 + (limpohon*0.5)) +'%)',
          'opacity': (scrollPercent >= 6.1 ? 0.15 : 1)
        }); 
        $('.pohonpohon').css({
          'transform' : 'translate(0, '+ (340-limpohon*0) +'%) scale('+ (300 + (limdaun * 2.7)) +'%)',
          'opacity': (scrollPercent >= 6.1 ? 0.15 : 1)
        }); 
        $('.daun').css({
          'transform' : 'translate(0, '+ (-360-limdaun*0.5) +'%) scale('+ (200 + (limdaun * 2.7)) +'%)',
          'opacity': (scrollPercent >= 6.1 ? 0.15 : 1)
        });
        $('.sec1 .orange.text-shadow').css({
          'text-shadow': ('1px 1px 1px rgb(255, 255, 255)')
        ...
        // Section 1
        $('.wanita-swipe').css({
          'transform' : 'translate('+ (-75) + '%, '+ (300+limQuarter*120) +'%) scale('+ (180) +'%)',
          'opacity': (scrollPercent >= 3.7 ? 0 : 1)
        });
        $('.pria-swipe').css({
          'transform' : 'translate('+ (-145) + '%, '+ (300+limQuarter*120) +'%) scale('+ (180) +'%)',
          'opacity': (scrollPercent >= 3.7 ? 0 : 1)
        });
        $('.quarter').css({
          'position' : 'fixed',
          'transform' : 'translate('+ (10) + '%, '+ (-1120-limQuarter*400) +'%) scale('+ (120) +'%)',
          'opacity': (scrollPercent >= 1.15 ? 0 : 1)
        }); 
        $('.quarter2').css({
          'position' : 'fixed',
          'transform' : 'translate('+ (10) + '%, '+ (-440-limQuarter*140) +'%) scale('+ (120) +'%)',
          'opacity': (scrollPercent >= 1.15 ? 0 : 1)
        }); 
        $('.pohon').css({
          'transform' : 'translate('+ (25) + '%, '+ (250+limpohon*1.5) +'%) scale('+ (195 + (limpohon*1.5)) +'%)',
          'opacity': (scrollPercent >= 7 ? 0.15 : 1)
        }); 
        $('.pohon-flip').css({
          'transform' : 'translate('+ (-5+limpohon*0.5) + '%, '+ (225-limpohon*1.5) +'%) scaleX(-1) scale('+ (155 + (limpohon*1.5)) +'%)',
          'opacity': (scrollPercent >= 7 ? 0.15 : 1)
        }); 
        $('.pohonpohon').css({
          'transform' : 'translate(0, '+ (240) +'%) scale('+ (300 + (limdaun * 2.7)) +'%)',
          'opacity': (scrollPercent >= 7 ? 0.15 : 1)
        }); 
        $('.daun').css({
          'transform' : 'translate(0, '+ (-270-limdaun*0.5) +'%) scale('+ (200 + (limdaun * 2.7)) +'%)',
        ...
        $('.p2sec2').css({
          'transform' : 'translate(0, '+ (120)+'%)', 'text-shadow': ('1px 1px 5px rgb(255, 255, 255)'),
          'opacity': (scrollPercent >= 0.7 ? 1 : 0)
        });
        $('.fsk').css({
          'transform' : 'translate(0, '+ (-80+wScroll*0.45) +'%) scale('+ (30 + (wScroll * 0.15)) +'%)', 'text-shadow': ('1px 1px 1px rgb(0, 0, 0.1)') ,
          'opacity': (scrollPercent >= 1 ? 1 : 0)
        });
        ...
        // Section 1
        $('.wanita-swipe').css({
          'transform' : 'translate('+ (-75) + '%, '+ (190+limQuarter*120) +'%) scale('+ (180) +'%)',
          'opacity': (scrollPercent >= 3.7 ? 0 : 1)
        });
        $('.pria-swipe').css({
          'transform' : 'translate('+ (-145) + '%, '+ (190+limQuarter*120) +'%) scale('+ (180) +'%)',
          'opacity': (scrollPercent >= 3.7 ? 0 : 1)
        });
        $('.quarter').css({
          'position' : 'fixed',
          'transform' : 'translate('+ (10) + '%, '+ (-920-limQuarter*174) +'%) scale('+ (120) +'%)',
          'opacity': (scrollPercent >= 1.15 ? 0 : 1)
        }); 
        $('.quarter2').css({
          'position' : 'fixed',
          'transform' : 'translate('+ (10) + '%, '+ (-350-limQuarter*64) +'%) scale('+ (120) +'%)',
          'opacity': (scrollPercent >= 1.15 ? 0 : 1)
        }); 
        $('.pohon').css({
          'transform' : 'translate('+ (25) + '%, '+ (210+limpohon*1.5) +'%) scale('+ (195 + (limpohon*1.5)) +'%)',
        ...
        $('.daun').css({
          'transform' : 'translate(0, '+ (-190-limdaun*0.5) +'%) scale('+ (200 + (limdaun * 2.7)) +'%)',
          'opacity': bgfixed2(scrollPercent)
        });
        ...
        $('.qlcmb').css({
          'transform' : 'translate(0, '+ (120)+'%) scale('+ (140) +'%)',
          'opacity': (scrollPercent >= 0.9 ? 1 : 0)
        });
        $('.p2sec2').css({
          'transform' : 'translate(0, '+ (140)+'%)', 'text-shadow': ('1px 1px 5px rgb(255, 255, 255)'),
          'opacity': (scrollPercent >= 1.85 ? 1 : 0)
        });
        $('.fsk').css({
          'transform' : 'translate(0, '+ (-140+wScroll*0.45) +'%) scale('+ (30 + (wScroll * 0.15)) +'%)', 'text-shadow': ('1px 1px 1px rgb(0, 0, 0.1)') ,
        ...
        // Section 1
        $('.wanita-swipe').css({
          'transform' : 'translate('+ (-75) + '%, '+ (120+limQuarter*128) +'%) scale('+ (150 - (wScroll * 0.0)) +'%)',
          'opacity': (scrollPercent >= 8.4 ? 0 : 1)
        });
        $('.pria-swipe').css({
          'transform' : 'translate('+ (-145) + '%, '+ (120+limQuarter*128) +'%) scale('+ (150 - (wScroll * 0.0)) +'%)',
          'opacity': (scrollPercent >= 8.4 ? 0 : 1)
        });
        $('.quarter').css({
          'position' : 'fixed',
          'transform' : 'translate(0, '+ (-680-limQuarter*204) +'%) scale('+ (100) +'%)',
          'opacity': (scrollPercent >= 1.1 ? 0 : 1)
        }); 
        $('.quarter2').css({
          'position' : 'fixed',
          'transform' : 'translate(0, '+ (-260-limQuarter*74) +'%) scale('+ (100) +'%)',
          'opacity': (scrollPercent >= 1.1 ? 0 : 1)
        }); 
        $('.pohon').css({
          'transform' : 'translate('+ (10) + '%, '+ (140+limpohon*1.5) +'%) scale('+ (125 + (limpohon*1.5)) +'%)',
          'opacity': (scrollPercent >= 8.4 ? 0.15 : 1) 
        }); 
        $('.pohon-flip').css({
          'transform' : 'translate('+ (-10+limpohon*0.5) + '%, '+ (135-limpohon*1.5) +'%) scaleX(-1) scale('+ (135 + (limpohon*1.5)) +'%)',
          'opacity': (scrollPercent >= 8.4 ? 0.15 : 1)
        }); 
        $('.pohonpohon').css({
          'transform' : 'translate(0, '+ (200) +'%) scale('+ (250 + (limdaun * 2.7)) +'%)',
          'opacity': (scrollPercent >= 8.4 ? 0.15 : 1)
        }); 
        $('.daun').css({
          'transform' : 'translate(0, '+ (-140-limdaun*0.5) +'%) scale('+ (200 + (limdaun * 2.7)) +'%)',
        ...
        $('.qlcmb').css({
          'transform' : 'scale('+ (150) +'%) translate(0, '+ (-55+wScroll*0.05) +'%)',
          'opacity': (scrollPercent >= 0.65 ? 1 : 0)
        });
        $('.p2sec2').css({
          'transform' : 'translate(0, '+ (-130)+'%) scale('+ (130) +'%)',
          'opacity': (scrollPercent >= 1 ? 1 : 0)
        });
        $('.fsk').css({
          'transform' : 'translate(0, '+ (-400+wScroll*0.75) +'%) scale('+ (60 + (wScroll * 0.17)) +'%)', 'text-shadow': ('1px 1px 1px rgb(0, 0, 0.1)') ,
          'opacity': (scrollPercent >= 1.2 ? 1 : 0)
        });

        // Section 3
        $('.pria-sec4').css({
          'transform': 'translate(' + (-82 + menScrollX450*8) + '%, ' + (-1665 + limLeft*185) + '%) scale('+ menScale576 +'%)',
        ...
        // Section 1
        $('.wanita-swipe').css({
          'transform' : 'translate('+ (-75) + '%, '+ (140+limQuarter*128) +'%) scale('+ (180 - (wScroll * 0.0)) +'%)',
          'opacity': (scrollPercent >= 8.4 ? 0 : 1)
        });
        $('.pria-swipe').css({
          'transform' : 'translate('+ (-145) + '%, '+ (140+limQuarter*128) +'%) scale('+ (180 - (wScroll * 0.0)) +'%)',
          'opacity': (scrollPercent >= 8.4 ? 0 : 1)
        });
        $('.quarter').css({
          'position' : 'fixed',
          'transform' : 'translate(0, '+ (-770-limQuarter*284) +'%) scale('+ (100) +'%)',
          'opacity': (scrollPercent >= 1.1 ? 0 : 1)
        }); 
        $('.quarter2').css({
          'position' : 'fixed',
          'transform' : 'translate(0, '+ (-300-limQuarter*104) +'%) scale('+ (100) +'%)',
          'opacity': (scrollPercent >= 1.1 ? 0 : 1)
        }); 
        $('.pohon').css({
          'transform' : 'translate('+ (17) + '%, '+ (170+limpohon*1.5) +'%) scale('+ (165 + (limpohon*1.5)) +'%)',
          'opacity': (scrollPercent >= 8.4 ? 0.15 : 1) 
        }); 
        $('.pohon-flip').css({
          'transform' : 'translate('+ (limpohon*0.5) + '%, '+ (145-limpohon*1.5) +'%) scaleX(-1) scale('+ (125 + (limpohon*1.5)) +'%)',
          'opacity': (scrollPercent >= 8.4 ? 0.15 : 1)
        }); 
        $('.pohonpohon').css({
          'transform' : 'translate(0, '+ (200) +'%) scale('+ (250 + (limdaun * 2.7)) +'%)',
        ...
        $('.daun').css({
          'transform' : 'translate(0, '+ (-165-limdaun*0.5) +'%) scale('+ (200 + (limdaun * 2.7)) +'%)',
          'opacity': bgfixed(scrollPercent)
        });
        ...
        // Section 1
        $('.wanita-swipe').css({
          'transform' : 'translate('+ (-75) + '%, '+ (200+limQuarter*88) +'%) scale('+ (180 - (wScroll * 0.0)) +'%)',
          'opacity': (scrollPercent >= 8.4 ? 0 : 1)
        });
        $('.pria-swipe').css({
          'transform' : 'translate('+ (-145) + '%, '+ (200+limQuarter*88) +'%) scale('+ (180 - (wScroll * 0.0)) +'%)',
          'opacity': (scrollPercent >= 8.4 ? 0 : 1)
        });
        $('.quarter').css({
          'position' : 'fixed',
          'transform' : 'translate(0, '+ (-830-limQuarter*454) +'%) scale('+ (100) +'%)',
          'opacity': (scrollPercent >= 1 ? 0 : 1)
        }); 
        $('.quarter2').css({
          'position' : 'fixed',
          'transform' : 'translate(0, '+ (-340-limQuarter*154) +'%) scale('+ (100) +'%)',
          'opacity': (scrollPercent >= 1 ? 0 : 1)
        }); 
        $('.pohon').css({
          'transform' : 'translate('+ (17) + '%, '+ (200+limpohon*1.5) +'%) scale('+ (165 + (limpohon*1.5)) +'%)',
          'opacity': (scrollPercent >= 8.4 ? 0.15 : 1)
        }); 
        $('.pohon-flip').css({
          'transform' : 'translate('+ (limpohon*0.5) + '%, '+ (165-limpohon*1.5) +'%) scaleX(-1) scale('+ (125 + (limpohon*1.5)) +'%)',
          'opacity': (scrollPercent >= 8.4 ? 0.15 : 1)
        }); 
        $('.pohonpohon').css({
          'transform' : 'translate(0, '+ (200) +'%) scale('+ (250 + (limdaun * 2.7)) +'%)',
        ...
        $('.daun').css({
          'transform' : 'translate(0, '+ (-205-limdaun*0.5) +'%) scale('+ (200 + (limdaun * 2.7)) +'%)',
          'opacity': bgfixed(scrollPercent)
        });
        ...
        $('.qlcmb').css({
          'transform' : 'scale('+ (130) +'%) translate(0, '+ (-55+wScroll*0.05) +'%)',
          'opacity': (scrollPercent >= 0.3 ? 1 : 0)
        });
        $('.p2sec2').css({
          'transform' : 'translate(0, '+ (-130)+'%) scale('+ (130) +'%)',
        ...
        // Section 1
        $('.wanita-swipe').css({
          'transform' : 'translate('+ (-75) + '%, '+ (140+limQuarter*74) +'%) scale('+ (180 - (wScroll * 0.0)) +'%)',
          'opacity': (scrollPercent >= 8.4 ? 0 : 1)
        });
        $('.pria-swipe').css({
          'transform' : 'translate('+ (-145) + '%, '+ (140+limQuarter*74) +'%) scale('+ (180 - (wScroll * 0.0)) +'%)',
          'opacity': (scrollPercent >= 8.4 ? 0 : 1)
        });
        $('.quarter').css({
          'position' : 'fixed',
          'transform' : 'translate(0, '+ (-830-limQuarter*94) +'%) scale('+ (100) +'%)',
          'opacity': (scrollPercent >= 1.45 ? 0 : 1)
        }); 
        $('.quarter2').css({
          'position' : 'fixed',
          'transform' : 'translate(0, '+ (-310-limQuarter*34) +'%) scale('+ (100) +'%)',
          'opacity': (scrollPercent >= 1.45 ? 0 : 1)
        }); 
        $('.pohon').css({
          'transform' : 'translate('+ (14) + '%, '+ (150+limpohon*1.5) +'%) scale('+ (155 + (limpohon*1.5)) +'%)',
          'opacity': (scrollPercent >= 8.4 ? 0.15 : 1)
        }); 
        $('.pohon-flip').css({
          'transform' : 'translate('+ (4+limpohon*0.5) + '%, '+ (135-limpohon*1.5) +'%) scaleX(-1) scale('+ (125 + (limpohon*1.5)) +'%)',
          'opacity': (scrollPercent >= 8.4 ? 0.15 : 1)
        }); 
        $('.pohonpohon').css({
        ...
        $('.p2sec2').css({
          'transform' : 'translate(0, '+ (-220)+'%) scale('+ (130) +'%)',
          'opacity': (scrollPercent >= 1.1 ? 1 : 0)
        });
        $('.fsk').css({
          'transform' : 'translate(0, '+ (-550+wScroll*0.75) +'%) scale('+ (40 + (wScroll * 0.17)) +'%)', 'text-shadow': ('1px 1px 1px rgb(0, 0, 0.1)') ,
          'opacity': (scrollPercent >= 1.2 ? 1 : 0)
        });

        // Section 3
        $('.pria-sec4').css({
          'transform': 'translate(' + (-80 + menScrollX450*7) + '%, ' + (-1255 + (Math.min(scrollPercent, 11.6))*110) + '%) scale('+ menScale780 +'%)',
        ...
        // Section 7
        $('.w-150').css({
          'transform' : 'translate('+ (40) +'%, '+ (85) +'%) scale('+ (1.5) +')'
        });
        ...
        // Section 17         
        $('.dampak').css({
          'transform' : 'translate('+ (-40) +'%, '+ (107) +'%) scale('+ (1.5) +')'
        });
        ...
        // Section 1
        $('.wanita-swipe').css({
          'transform' : 'translate('+ (-75) + '%, '+ (150+limQuarter*54) +'%) scale('+ (150 - (wScroll * 0.0)) +'%)',
          'opacity': (scrollPercent >= 8.4 ? 0 : 1)
        });
        $('.pria-swipe').css({
          'transform' : 'translate('+ (-145) + '%, '+ (150+limQuarter*54) +'%) scale('+ (150 - (wScroll * 0.0)) +'%)',
          'opacity': (scrollPercent >= 8.4 ? 0 : 1)
        });
        $('.quarter').css({
          'position' : 'fixed',
        ...
        $('.pohonpohon').css({
          'transform' : 'translate(0, '+ (140-limpohon*0) +'%) scale('+ (200 + (limdaun * 2.7)) +'%)',
          'opacity': (scrollPercent >= 8.4 ? 0.15 : 1)
        }); 
        $('.daun').css({
          'transform' : 'translate(0, '+ (-135-limdaun*0.5) +'%) scale('+ (200 + (limdaun * 2.7)) +'%)',
          'opacity': bgfixed(scrollPercent)
        });
        ...
        // Section 1
        $('.wanita-swipe').css({
          'transform' : 'translate('+ (-75) + '%, '+ (180+limQuarter*54) +'%) scale('+ (150 - (wScroll * 0.0)) +'%)',
          'opacity': (scrollPercent >= 8.4 ? 0 : 1)
        });
        $('.pria-swipe').css({
          'transform' : 'translate('+ (-145) + '%, '+ (180+limQuarter*54) +'%) scale('+ (150 - (wScroll * 0.0)) +'%)',
          'opacity': (scrollPercent >= 8.4 ? 0 : 1)
        });
        $('.quarter').css({
          'position' : 'fixed',
          'transform' : 'translate(0, '+ (-1000-limQuarter*150) +'%) scale('+ (100) +'%)',
          'opacity': (scrollPercent >= 1.2 ? 0 : 1)
        }); 
        $('.quarter2').css({
          'position' : 'fixed',
          'transform' : 'translate(0, '+ (-370-limQuarter*54) +'%) scale('+ (100) +'%)',
          'opacity': (scrollPercent >= 1.2 ? 0 : 1)
        }); 
        $('.pohon').css({
          'transform' : 'translate('+ (14) + '%, '+ (160+limpohon*0.6) +'%) scale('+ (155 + (limpohon*0.5)) +'%)',
          'opacity': (scrollPercent >= 8.4 ? 0.15 : 1)
        }); 
        $('.pohon-flip').css({
          'transform' : 'translate('+ (4+limpohon*0.5) + '%, '+ (95-limpohon*0.6) +'%) scaleX(-1) scale('+ (125 + (limpohon*0.5)) +'%)',
        ...
        $('.daun').css({
          'transform' : 'translate(0, '+ (-160-limdaun*0.5) +'%) scale('+ (200 + (limdaun * 2.7)) +'%)',
          'opacity': bgfixed(scrollPercent)
        });
        ...
        $('.fsk').css({
          'transform' : 'translate(0, '+ (-180+wScroll*0.1) +'%) scale('+ (40 + (wScroll * 0.55)) +'%)', 'text-shadow': ('1px 1px 1px rgb(0, 0, 0.1)') ,
          'opacity': (scrollPercent >= 0.8 ? 1 : 0)
        });
        $('.img-sec2 .position-start').css({
          'transform' : 'scale('+ (25 + (wScroll * 0.1)) +'%) translate('+ (120-wScroll*0.1) + '%, '+ (-85+wScroll*0.05) +'%)'
        ...
        // Section 3
        $('.pria-sec4').css({
          'transform': 'translate(' + (-770 + menScrollY375*55) + '%, ' + (-915 + menScrollY375*69) + '%) scale('+ menScale1250 +'%)',
        ...
        // Section 17
        $('.dampak').css({
          'transform' : 'translate(0, '+ (70)+'%) scale(' + (100) + '%)'
        });
      } else if (window.matchMedia("(max-width: 1024px) and (min-height: 651px)").matches) {
        // Section 1
        $('.wanita-swipe').css({
          'transform' : 'translate('+ (-75) + '%, '+ (180+limQuarter*44) +'%) scale('+ (175 - (wScroll * 0.0)) +'%)',
          'opacity': (scrollPercent >= 8.4 ? 0 : 1)
        });
        $('.pria-swipe').css({
          'transform' : 'translate('+ (-145) + '%, '+ (180+limQuarter*44) +'%) scale('+ (175 - (wScroll * 0.0)) +'%)',
          'opacity': (scrollPercent >= 8.4 ? 0 : 1)
        });
        $('.quarter').css({
          'position' : 'fixed',
          'transform' : 'translate(0, '+ (-920-limQuarter*180) +'%) scale('+ (100) +'%)',
          'opacity': (scrollPercent >= 0.7 ? 0 : 1)
        }); 
        $('.quarter2').css({
          'position' : 'fixed',
          'transform' : 'translate(0, '+ (-255-limQuarter*54) +'%) scale('+ (100) +'%)',
          'opacity': (scrollPercent >= 0.7 ? 0 : 1)
        }); 
        $('.pohon').css({
          'transform' : 'translate('+ (14) + '%, '+ (140+limpohon*0.6) +'%) scale('+ (140 + (limpohon*0.5)) +'%)',
          'opacity': (scrollPercent >= 8.4 ? 0.15 : 1)
        }); 
        $('.pohon-flip').css({
          'transform' : 'translate('+ (limpohon*0.5) + '%, '+ (105-limpohon*0.6) +'%) scaleX(-1) scale('+ (125 + (limpohon*0.5)) +'%)',
          'opacity': (scrollPercent >= 8.4 ? 0.15 : 1)
        }); 
        $('.pohonpohon').css({
          'transform' : 'translate(0, '+ (140-limpohon*0) +'%) scale('+ (200 + (limdaun * 2.7)) +'%)',
        ...
        $('.daun').css({
          'transform' : 'translate(0, '+ (-130-limdaun*0.5) +'%) scale('+ (200 + (limdaun * 2.7)) +'%)',
          'opacity': bgfixed(scrollPercent)
        });
        ...
        $('.qlcmb').css({
          'transform' : 'scale('+ (140 + (wScroll * 0)) +'%) translate(0, '+ (-80-wScroll*0.25) +'%)',
          'opacity': (scrollPercent >= 0.5 ? 1 : 0)
        });
        $('.p2sec2').css({
          'transform' : 'translate(0, '+ (-250)+'%) scale('+ (150 + (wScroll * 0)) +'%)',
          'opacity': (scrollPercent >= 0.5 ? 1 : 0)
        });
        $('.fsk').css({
          'transform' : 'translate(0, '+ (-280+wScroll*0.1) +'%) scale('+ (52 + (wScroll * 0.2)) +'%)', 'text-shadow': ('1px 1px 1px rgb(0, 0, 0.1)') ,
          'opacity': (scrollPercent >= 0.8 ? 1 : 0)
        });
        $('.img-sec2 .position-start').css({
          'transform' : 'scale('+ (25 + (wScroll * 0.1)) +'%) translate('+ (120-wScroll*0.1) + '%, '+ (-85+wScroll*0.05) +'%)'
        ...
        // Section 3
        $('.pria-sec4').css({
          'transform': 'translate(' + (-770 + menScrollY375*55) + '%, ' + (-915 + menScrollY375*70) + '%) scale('+ menScale1250 +'%)',
           'opacity': (scrollPercent >= 1 ? 1 : 0)
        });
        ...
        // Section 1
        $('.pria-swipe').css({
          'transform' : 'translate('+ (-35-limRight576*35) + '%, '+ (35+limQuarter*35.3) +'%) scale('+ (108 - (wScroll * 0.02)) +'%)',
          'opacity': (scrollPercent >= 10 ? 0 : 1)
        });
        $('.wanita-swipe').css({
          'transform' : 'translate('+ (-20-limRight576*19) + '%, '+ (35+limQuarter*35.3) +'%) scale('+ (108 - (wScroll * 0.02)) +'%)',
          'opacity': (scrollPercent >= 10 ? 0 : 1)
        });
        $('.quarter').css({
          'position' : 'fixed',
        ...
        $('.quarter2').css({
          'position' : 'fixed',
          'transform' : 'translate('+ (-5-wScroll*0.055) + '%, '+ (limQuarter*15) +'%) scale('+ (90 - (wScroll * 0.06)) +'%)',
          'opacity': (scrollPercent >= 4 ? 0 : 1)
        }); 
        $('.pohon').css({
          'transform' : 'translate('+ (2-limpohon*0.5) + '%, '+ (15+limpohon*0.6) +'%) scale('+ (100 + (limpohon*0.5)) +'%)',
          'opacity': (scrollPercent >= 14.1 ? 0.15 : 1)
        }); 
        $('.pohon-flip').css({
          'transform' : 'translate('+ (limpohon*0.5) + '%, '+ (-limpohon*0.6) +'%) scaleX(-1)',
        ...
        $('.daun').css({
          'transform' : 'translate(0, '+ (-30-limdaun*0.5) +'%)', 
          'opacity': bgfixed(scrollPercent)
        });
        ...
        $('.fsk').css({
          'transform' : 'translate(0, '+ (-330+wScroll*0.35) +'%) scale('+ (-30 + (wScroll * 0.105)) +'%)',
          'opacity': (scrollPercent >= 4.2 ? 1 : 0)
        });

        // Section 3
        $('.pria-sec4').css({
          'transform': 'translate(' + (-710 + menScrollY375*50) + '%, ' + (-755 + (Math.min(scrollPercent, 13))*63) + '%) scale('+ menScale1250 +'%)',
           'opacity': (scrollPercent >= 9 ? 1 : 0)
        });

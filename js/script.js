...
// SET ALL PARALLAX EFFECTS
    ...
    function responsiveEffect(wScroll) {
      ...
      var limit12 = Math.min(scrollPercent, 12.5)
      var limit13 = Math.min(scrollPercent, 13.5)
      var menScrollY375 = Math.min(scrollPercent, 14);
      var lim1024 = Math.min(scrollPercent, 15.5);
      var limit16 = Math.min(scrollPercent, 16.5);
      ...
      function menOpacity(scrollPercent) {
        ...
        if(scrollPercent < 4.9) return 1;
        if(scrollPercent < 6.7) return 0;
        return 1; 
      }
      function menOpacity576(scrollPercent) {
        if(scrollPercent < 5.2) return 0;
        if(scrollPercent < 6) return 1;
        if(scrollPercent < 7.6) return 0;
        return 1; 
      }
      ...
      function menOpacity991(scrollPercent) {
        ...
        if(scrollPercent < 12) return 0;
        return 1; 
      }
      function menOpacity375(scrollPercent) {
        if(scrollPercent < 7.2) return 0;
        if(scrollPercent < 9.5) return 1;
        if(scrollPercent < 13) return 0;
        return 1; 
      }
      function menOpacity611(scrollPercent) {
        if(scrollPercent < 4) return 0;
        if(scrollPercent < 7.6) return 1;
        if(scrollPercent < 10.4) return 0;
        return 1; 
      }
      function menOpacity450(scrollPercent) {
        if(scrollPercent < 4) return 0;
        if(scrollPercent < 5.5) return 1;
        if(scrollPercent < 7.5) return 0;
        return 1; 
      }
      ...
      switch(currentDevice){
        case "one":
          // Section 1
        $wanitaSwipe.css({
          'transform': `translate3d(${-75}%, ${223+limQuarter*170}%, 0) scale(${180}%)`,
          'opacity': (scrollPercent >= 3.7 ? 0 : 1)
        });
        $priaSwipe.css({
          'transform': `translate3d(${-145}%, ${205+limQuarter*170}%, 0) scale(${180}%)`,
          'opacity': (scrollPercent >= 3.7 ? 0 : 1)
        });
        $quarter.css({
          'position' : 'fixed',
        ...
        $pohonPohon.css({
          'transform' : `translate3d(0, ${230-limpohon*0}%, 0) scale(${300 + (limdaun * 2.7)}%)`  ,
          'opacity': (scrollPercent >= 6.1 ? 0.15 : 1)
        }); 
        $daun.css({
        ...
        $priaSwipe.css({
          'transform' : `translate3d(${-145}%, ${245+limQuarter*150}%, 0) scale(${180}%)`,
          'opacity': (scrollPercent >= 3.7 ? 0 : 1)
        });
        $quarter.css({
          'position' : 'fixed',
        ...
        case "four":
          // Section 1
        $wanitaSwipe.css({
          'transform' : `translate3d(${-75}%, ${365+limQuarter*155}%, 0) scale(${180}%)`,
          'opacity': (scrollPercent >= 3.7 ? 0 : 1)
        });
        $priaSwipe.css({
          'transform' : `translate3d(${-145}%, ${340+limQuarter*155}%, 0) scale(${180}%)`,
          'opacity': (scrollPercent >= 3.7 ? 0 : 1)
        });
        $quarter.css({
          'position' : 'fixed',
        ...
        // Section 3
        $priaSec4.css({
          'transform': `translate3d(${-68 + menScrollX450*8}%, ${-1580 + limpohon*225}%, 0) scale(${menScale375}%)`,
           'opacity': menOpacity(scrollPercent)
        });
        ...
        case "five":
          // Section 1
        $wanitaSwipe.css({
          'transform' : `translate3d(${-75}%, ${280+limQuarter*135}%, 0) scale(${180}%)`,
          'opacity': (scrollPercent >= 3.7 ? 0 : 1)
        });
        $priaSwipe.css({
          'transform' : `translate3d(${-145}%, ${280+limQuarter*135}%, 0) scale(${180}%)`,
          'opacity': (scrollPercent >= 3.7 ? 0 : 1)
        });
        $quarter.css({
          'position' : 'fixed',
        ...
        // Section 3
        $priaSec4.css({
          'transform': `translate3d(${-82 + menScrollX450*8}%, ${-1850 + (Math.min(scrollPercent, 8.2))*230}%, 0) scale(${menScale576}%)`,
        ...
        case "six":
          // Section 1
        $wanitaSwipe.css({
          'transform' : `translate3d(${-75}%, ${230+limQuarter*125}%, 0) scale(${180}%)`,
          'opacity': (scrollPercent >= 3.7 ? 0 : 1)
        });
        $priaSwipe.css({
          'transform' : `translate3d(${-145}%, ${230+limQuarter*125}%, 0) scale(${180}%)`,
          'opacity': (scrollPercent >= 3.7 ? 0 : 1)
        });
        $quarter.css({
          'position' : 'fixed',
        ...
        // Section 3
        $priaSec4.css({
          'transform': `translate3d(${-82 + menScrollX450*8}%, ${-1850 + (Math.min(scrollPercent, 8.7))*215}%, 0) scale(${menScale576}%)`,
           'opacity': menOpacity576(scrollPercent)
        });
        ...
        // Section 3
        $priaSec4.css({
          'transform': `translate3d(${-82 + menScrollX450*8}%, ${-1800 + limRight*205}%, 0) scale(${menScale576}%)`,
           'opacity': menOpacity576(scrollPercent)
        });
        ...
        $pohon.css({
          'transform' : `translate3d(${25}%, ${210+limpohon*1.5}%, 0) scale(${195 + (limpohon*5.5)}%)`,
          'opacity': (scrollPercent >= 7 ? 0.15 : 1)
        }); 
        $pohonFlip.css({
          'transform' : `translate3d(${-5+limpohon*0.5}%, ${215-limpohon*1.5}%, 0) scaleX(-1) scale(${155 + (limpohon*5.5)}%)`,
          'opacity': (scrollPercent >= 7 ? 0.15 : 1)
        }); 
        $pohonPohon.css({
          'transform' : `translate3d(0, ${230}%, 0) scale(${300 + (limdaun * 2.7)}%)`,
        ...
        $daun.css({
          'transform' : `translate3d(0, ${-190-limdaun*0.5}%, 0) scale(${200 + (limdaun * 3.7)}%)`,
          'opacity': bgfixed2(scrollPercent)
        });
        ...
        case "ten":
          // Section 1
        $wanitaSwipe.css({
          'transform' : `translate3d(${-75}%, ${125+limQuarter*100}%, 0) scale(${150 - (wScroll * 0.0)}%)`,
          'opacity': (scrollPercent >= 8.4 ? 0 : 1)
        });
        $priaSwipe.css({
          'transform' : `translate3d(${-145}%, ${125+limQuarter*100}%, 0) scale(${150 - (wScroll * 0.0)}%)`,
          'opacity': (scrollPercent >= 8.4 ? 0 : 1)
        });
        $quarter.css({
          'position' : 'fixed',
        ...
        $pohon.css({
          'transform' : `translate3d(${10}%, ${140+limpohon*1.5}%, 0) scale(${125 + (limpohon*4.5)}%)`,
          'opacity': (scrollPercent >= 8.4 ? 0.15 : 1) 
        }); 
        $pohonFlip.css({
          'transform' : `translate3d(${-10+limpohon*0.5}%, ${135-limpohon*1.5}%, 0) scaleX(-1) scale(${135 + (limpohon*4.5)}%)`,
          'opacity': (scrollPercent >= 8.4 ? 0.15 : 1)
        }); 
        $pohonPohon.css({
          'transform' : `translate3d(0, ${200}%, 0) scale(${250 + (limdaun * 3.7)}%)`,
          'opacity': (scrollPercent >= 8.4 ? 0.15 : 1)
        }); 
        $daun.css({
        ...
        case "fourteen":
          // Section 1
        $wanitaSwipe.css({
          'transform' : `translate3d(${-75}%, ${140+limQuarter*88}%, 0) scale(${160 - (wScroll * 0.0)}%)` ,
          'opacity': (scrollPercent >= 8.4 ? 0 : 1)
        });
        $priaSwipe.css({
          'transform' : `translate3d(${-145}%, ${140+limQuarter*88}%, 0) scale(${160 - (wScroll * 0.0)}%)`,
          'opacity': (scrollPercent >= 8.4 ? 0 : 1)
        });
        $quarter.css({
          'position' : 'fixed',
        ...
        $pohon.css({
          'transform' : `translate3d(${14}%, ${150+limpohon*1.5}%, 0) scale(${155 + (limpohon*4.5)}%)`,
          'opacity': (scrollPercent >= 8.4 ? 0.15 : 1)
        }); 
        $pohonFlip.css({
          'transform' : `translate3d(${4+limpohon*0.5}%, ${135-limpohon*1.5}%, 0) scaleX(-1) scale(${125 + (limpohon*4.5)}%)`,
          'opacity': (scrollPercent >= 8.4 ? 0.15 : 1)
        }); 
        $pohonPohon.css({
          'transform' : `translate3d(0, ${130}%, 0) scale(${200 + (limdaun * 3.7)}%)`,
          'opacity': (scrollPercent >= 8.4 ? 0.15 : 1)
        }); 
        $daun.css({
        ...
        // Section 3
        $priaSec4.css({
          'transform': `translate3d(${-80 + menScrollX450*7}%, ${-1205 + (Math.min(scrollPercent, 11.3))*110}%, 0) scale(${menScale780}%)`,
           'opacity': menOpacity611(scrollPercent)
        });

        // Section 5 
        if(scrollPercent >= 10.2 && !typewriterStarted) {
          typewriterStarted = true;
          typeWriter();
          $('.cursor').css('opacity', scrollPercent >= 10.2 ? 1 : 0);
        }
        ...
        case "fifteen":
          // Section 1
        $wanitaSwipe.css({
          'transform' : 'translate('+ (-75) + '%, '+ (140+limQuarter*54) +'%) scale('+ (160 - (wScroll * 0.0)) +'%)',
          'opacity': (scrollPercent >= 8.4 ? 0 : 1)
        });
        $priaSwipe.css({
          'transform' : 'translate('+ (-145) + '%, '+ (140+limQuarter*54) +'%) scale('+ (160 - (wScroll * 0.0)) +'%)',
          'opacity': (scrollPercent >= 8.4 ? 0 : 1)
        });
        $quarter.css({
          'position' : 'fixed',
        ...
        $pohon.css({
          'transform' : 'translate('+ (14) + '%, '+ (140+limpohon*1.5) +'%) scale('+ (155 + (limpohon*4.5)) +'%)',
          'opacity': (scrollPercent >= 8.4 ? 0.15 : 1)
        }); 
        $pohonFlip.css({
          'transform' : 'translate('+ (4+limpohon*0.5) + '%, '+ (115-limpohon*1.5) +'%) scaleX(-1) scale('+ (125 + (limpohon*4.5)) +'%)',
          'opacity': (scrollPercent >= 8.4 ? 0.15 : 1)
        }); 
        $pohonPohon.css({
          'transform' : 'translate(0, '+ (140) +'%) scale('+ (200 + (limdaun * 3.7)) +'%)',
          'opacity': (scrollPercent >= 8.4 ? 0.15 : 1)
        }); 
        $daun.css({
        ...
        // Section 3
        $priaSec4.css({
          'transform': 'translate(' + (-110 + menScrollX450*10) + '%, ' + (-1105 + limit13*85) + '%) scale('+ menScale780 +'%)',
           'opacity': menOpacity375(scrollPercent)
        });

        // Section 5 
        if(scrollPercent >= 13 && !typewriterStarted) {
          typewriterStarted = true;
          typeWriter();
          $('.cursor').css('opacity', scrollPercent >= 13 ? 1 : 0);
        }
        ...
        case "sixteen":
          // Section 1
        $wanitaSwipe.css({
          'transform' : 'translate3d('+ (-75) + '%, '+ (165+limQuarter*54) +'%, 0) scale('+ (150 - (wScroll * 0.0)) +'%)',
          'opacity': (scrollPercent >= 8.4 ? 0 : 1)
        });
        $priaSwipe.css({
          'transform' : 'translate3d('+ (-145) + '%, '+ (165+limQuarter*54) +'%, 0) scale('+ (150 - (wScroll * 0.0)) +'%)',
          'opacity': (scrollPercent >= 8.4 ? 0 : 1)
        });
        $quarter.css({
          'position' : 'fixed',
        ...
        $pohon.css({
          'transform' : 'translate3d('+ (14) + '%, '+ (130+limpohon*0.6) +'%, 0) scale('+ (155 + (limpohon*3.5)) +'%)',
          'opacity': (scrollPercent >= 8.4 ? 0.15 : 1)
        }); 
        $pohonFlip.css({
          'transform' : 'translate3d('+ (4+limpohon*0.5) + '%, '+ (95-limpohon*0.6) +'%, 0) scaleX(-1) scale('+ (125 + (limpohon*3.5)) +'%)',
          'opacity': (scrollPercent >= 8.4 ? 0.15 : 1)
        }); 
        $pohonPohon.css({
          'transform' : 'translate3d(0, '+ (140-limpohon*0) +'%, 0) scale('+ (200 + (limdaun * 3.7)) +'%)',
          'opacity': (scrollPercent >= 8.4 ? 0.15 : 1)
        }); 
        $daun.css({
        ...
        // Section 3
        $priaSec4.css({
          'transform': 'translate3d(' + (-115 + limLeft990*13) + '%, ' + (-1270 + limit12*108) + '%, 0) scale('+ menScale990 +'%)',
           'opacity': menOpacity991(scrollPercent)
        });

        // Section 5 
        if(scrollPercent >= 11.7 && !typewriterStarted) {
          typewriterStarted = true;
          typeWriter();
          $('.cursor').css('opacity', scrollPercent >= 11.7 ? 1 : 0);
        }
        ...
        $pohon.css({
          'transform' : 'translate3d('+ (14) + '%, '+ (160+limpohon*0.6) +'%, 0) scale('+ (155 + (limpohon*2.5)) +'%)',
          'opacity': (scrollPercent >= 8.4 ? 0.15 : 1)
        }); 
        $pohonFlip.css({
          'transform' : 'translate3d('+ (limpohon*0.5) + '%, '+ (125-limpohon*0.6) +'%, 0) scaleX(-1) scale('+ (135 + (limpohon*2.5)) +'%)',
          'opacity': (scrollPercent >= 8.4 ? 0.15 : 1)
        }); 
        $pohonPohon.css({
          'transform' : 'translate3d(0, '+ (150-limpohon*0) +'%, 0) scale('+ (210 + (limdaun * 3.7)) +'%)',
          'opacity': (scrollPercent >= 8.4 ? 0.15 : 1)
        }); 
        $daun.css({
        ...
        // Section 3
        $priaSec4.css({
          'transform': 'translate3d(' + (-125 + menScrollX450*13) + '%, ' + (-1190 + limit12*100) + '%, 0) scale('+ menScale990 +'%)',
           'opacity': menOpacity991(scrollPercent)
        });

        // Section 5 
        if(scrollPercent >= 11.2 && !typewriterStarted) {
          typewriterStarted = true;
          typeWriter();
          $('.cursor').css('opacity', scrollPercent >= 11.2 ? 1 : 0);
        }
        ...
        case "eighteen":
          // Section 1
        $priaSwipe.css({
          'transform' : 'translate3d('+ (-20-limRight576*28) + '%, '+ (15+limQuarter*40.3) +'%, 0) scale('+ (90 - (wScroll * 0.015)) +'%)',
          'opacity': (scrollPercent >= 6.9 ? 0 : 1)
        });
        $wanitaSwipe.css({
          'transform' : 'translate3d('+ (-20-limRight576*19) + '%, '+ (15+limQuarter*40.3) +'%, 0) scale('+ (90 - (wScroll * 0.015)) +'%)',
          'opacity': (scrollPercent >= 6.9 ? 0 : 1)
        });
        $quarter.css({
          'position' : 'fixed',
          'transform' : 'translate3d('+ (-18-wScroll*0.038) + '%, '+ (55+limQuarter*74) +'%, 0) scale('+ (90 - (wScroll * 0.01)) +'%)',
          'opacity': (scrollPercent >= 4.2 ? 0 : 1)
        }); 
        $quarter2.css({
          'position' : 'fixed',
          'transform' : 'translate3d('+ (-25-wScroll*0.0275) + '%, '+ (limQuarter*15) +'%, 0) scale('+ (60 - (wScroll * 0.03)) +'%)',
          'opacity': (scrollPercent >= 4.2 ? 0 : 1)
        }); 
        $pohon.css({
        ...
        $qlcmb.css({
          'opacity': (scrollPercent >= 3.6 ? 1 : 0)
        });
        $p2sec2.css({
          'transform' : 'translate3d(0, '+ (-30) +'%, 0) scale('+ (70) +'%)', 'opacity': (scrollPercent >= 4.2 ? 1 : 0)
        });
        $fsk.css({
        ...
        // Section 3
        $priaSec4.css({
          'transform': 'translate3d(' + (-730 + limit13*55) + '%, ' + (-860 + limit13*69) + '%, 0) scale('+ menScale1250 +'%)',
           'opacity': (scrollPercent >= 9.6 ? 1 : 0)
        });

        // Section 5 
        if(scrollPercent >= 16 && !typewriterStarted) {
          typewriterStarted = true;
          typeWriter();
          $('.cursor').css('opacity', scrollPercent >= 16 ? 1 : 0);
        }
        ...
        case "twenty":
          // Section 1
        $priaSwipe.css({
          'transform' : 'translate3d('+ (-35-limRight576*35) + '%, '+ (-5+limQuarter*41.3) +'%, 0) scale('+ (108 - (wScroll * 0.02)) +'%)',
          'opacity': (scrollPercent >= 10 ? 0 : 1)
        });
        $wanitaSwipe.css({
          'transform' : 'translate3d('+ (-20-limRight576*19) + '%, '+ (-5+limQuarter*41.3) +'%, 0) scale('+ (108 - (wScroll * 0.02)) +'%)',
          'opacity': (scrollPercent >= 10 ? 0 : 1)
        });
        $quarter.css({
          'position' : 'fixed',
        ...
        $pohon.css({
          'transform' : 'translate3d('+ (2-limpohon*0.5) + '%, '+ (+limpohon*0.6) +'%, 0) scale('+ (100 + (limpohon*0.5)) +'%)',
        ...
        // Section 3
        $priaSec4.css({
          'transform': 'translate3d(' + (-670 + menScrollY375*50) + '%, ' + (-715 + limit12*63) + '%, 0) scale('+ menScale1250 +'%)',
           'opacity': (scrollPercent >= 8.9 ? 1 : 0)
        });

        // Section 5 
        if(scrollPercent >= 16.2 && !typewriterStarted) {
          typewriterStarted = true;
          typeWriter();
          $('.cursor').css('opacity', scrollPercent >= 16.2 ? 1 : 0);
        }
        ...
        $qlcmb.css({
          'transform' : `translate3d(0, ${50}%, 0) scale(${90}%)`,
        ...
        // Section 3
        $priaSec4.css({
          'transform': `translate3d(${-680 + menScrollY375*50}%, ${-715 + limit12*63}%, 0) scale(${menScale1250}%)`,
           'opacity': (scrollPercent >= 9 ? 1 : 0)
        });

        // Section 5 
        if(scrollPercent >= 15.3 && !typewriterStarted) {
          typewriterStarted = true;
          typeWriter();
          $('.cursor').css('opacity', scrollPercent >= 15.3 ? 1 : 0);
        }
        ...
        case "twentytwo":
          // Section 1
        $priaSwipe.css({
          'transform': `translate3d(${-20-limLeft375*26.3}%, ${-5+limQuarter*37.3}%, 0) scale(${108 - (wScroll * 0.03)}%)`,
          'opacity': (scrollPercent >= 10 ? 0 : 1)
        });
        $wanitaSwipe.css({
          'transform': `translate3d(${-20-limLeft375*18.3}%, ${-5+limQuarter*37.3}%, 0) scale(${108 - (wScroll * 0.03)}%)`,
          'opacity': (scrollPercent >= 10 ? 0 : 1)
        });
        $quarter.css({
          'position' : 'fixed',
        ...
        $qlcmb.css({
          'transform' : `translate3d(0, ${80}%, 0) scale(${90}%)`,
          'opacity': (scrollPercent >= 5 ? 1 : 0)
        });
        $p2sec2.css({
          'transform' : `translate3d(0, ${40}%, 0) scale(${70}%)`,
          'opacity': (scrollPercent >= 5 ? 1 : 0)
        });
        $fsk.css({
          'transform' : `translate3d(0, ${-370+wScroll*0.35}%, 0) scale(${-30 + (wScroll * 0.105)}%)`,
          'opacity': (scrollPercent >= 5 ? 1 : 0)
        });

        // Section 3
        $priaSec4.css({
          'transform': `translate3d(${-680 + menScrollY375*47}%, ${-745 + menScrollY375*60}%, 0) scale(${menScale1250}%)`,
           'opacity': (scrollPercent >= 9.5 ? 1 : 0)
        });

        // Section 5 
        if(scrollPercent >= 17.3 && !typewriterStarted) {
          typewriterStarted = true;
          typeWriter();
          $('.cursor').css('opacity', scrollPercent >= 17.3 ? 1 : 0);
        }
        ...
        case "twentythree":
          // Section 1
        $priaSwipe.css({
          'transform': `translate3d(${-20-limLeft375*25.8}%, ${10+limQuarter*31.6}%, 0) scale(${100 - (wScroll * 0.015)}%)`,
          'opacity': (scrollPercent >= 12 ? 0 : 1)
        });
        $wanitaSwipe.css({
          'transform': `translate3d(${-20-limLeft375*17.8}%, ${10+limQuarter*31.55}%, 0) scale(${100 - (wScroll * 0.015)}%)`,
          'opacity': (scrollPercent >= 10 ? 0 : 1)
        });
        $quarter.css({
          'position' : 'fixed',
        ...
        $qlcmb.css({
          'transform' : `translate3d(0, ${50}%, 0) scale(${90}%)`, 'opacity': (scrollPercent >= 5.2 ? 1 : 0)
        });
        $p2sec2.css({
        ...
        // Section 3
        $priaSec4.css({
          'transform': `translate3d(${-595 + limit16*36.7}%, ${-585 + lim1024*42}%, 0) scale(${menScale}%)`,
        ...
        // Section 1
        $priaSwipe.css({
          'transform': `translate3d(${-20-limSwipeX*21.6}%, ${10+limQuarter*28.6}%, 0) scale(${100 - (wScroll * 0.005)}%)`,
          'opacity': (scrollPercent >= 10 ? 0 : 1)
        });
        $wanitaSwipe.css({
          'transform': `translate3d(${-22-limSwipeX*13.6}%, ${10+limQuarter*28.65}%, 0) scale(${100 - (wScroll * 0.005)}%)`,
          'opacity': (scrollPercent >= 10 ? 0 : 1)
        });
        $quarter.css({
          'transform': `translate3d(${-wScroll*0.035}%, ${5+limQuarter*8}%, 0) scale(${100 - (wScroll * 0.04)}%)`,
          'opacity': (scrollPercent >= 5.8 ? 0 : 1)
        }); 
        $quarter2.css({
          'transform' : `translate3d(${-wScroll*0.029}%, ${15-limQuarter*2.3}%, 0) scale(${100 - (wScroll * 0.04)}%)`,
          'opacity': (scrollPercent >= 5.8 ? 0 : 1)
        }); 
        $txtSec1.css({
        ...
        $qlcmb.add($p2sec2).css({
          'transform' : `translate3d(0, ${65}%, 0)`, 'opacity': (scrollPercent >= 5.8 ? 1 : 0)
        });
        $fsk.css({
        ...
        // Section 3
        $priaSec4.css({
          'transform': `translate3d(${-630 + menScrollX990*35}%, ${-530 + menScrollY450*34.5}%, 0) scale(${menScale}%)`,
           'opacity': (scrollPercent >= 11.6 ? 1 : 0)
        });
